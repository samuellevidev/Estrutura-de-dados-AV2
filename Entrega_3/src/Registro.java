...
private String descricao, linha; //Variável que define o que são os produtos, e o valor em formato string.
...
private int opcao; //Variável que irá armazenar a escolha do usuário na Classe  "Menu".
